...
class C(BaseConstants):
    ...
    HIDE_CHAT = True
    HIDE_SKIP = True
    ADVICE_INFO = "The advice is generated by artificial intelligence which accounts for the full history of play to maximize efficiency and equity. This is the best-performing advice we have encountered. It is possible that you may achieve greater bonus without following this advice, but it optimizes outcomes only for those who follow the advice."
